...
.Net微服务书籍：[https://learn.microsoft.com/zh-cn/dotnet/architecture/microservices/](https://learn.microsoft.com/zh-cn/dotnet/architecture/microservices/)

.Net框架揭秘：[https://www.cnblogs.com/artech/p/inside-asp-net-core-6.html](https://www.cnblogs.com/artech/p/inside-asp-net-core-6.html)  

20+本.net开发必看书籍推荐：[https://jhrs.com/2021/41653.html](https://jhrs.com/2021/41653.html)

## C#

C#本质论 => C# in depth => Clr via C#，之后就应该有自己的学习方向了

### CLR via C# 第4版框架设计

《CLR via C#（第4版）》针对CLR和.NET Framework 4.5进行深入、全面探讨，并结合实例介绍了如何利用它们进行设计、开发和调试。全书5部分共29章。第Ⅰ部分介绍CLR基础，第Ⅱ部分解释如何设计类型，第Ⅲ部分介绍基本类型，第Ⅳ部分以核心机制为主题，第Ⅴ部分重点介绍线程处理。通过本书的阅读，读者可以掌握CLR和.NET Framework的精髓，轻松、高效地创建高性能应用程序。
