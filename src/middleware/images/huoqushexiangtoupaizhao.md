...
tag:
  - 无
filename: huoqushexiangtoupaizhao
slug: wg922d
docsId: '47107032'
---
公共类
    ...
    private void getQrcode()
        {
            try
            {
                ...
                while (i <= 1)
                {
                    p.GrabImage("e:\\Decode.bmp");
                    p.Kinescope("e:\\Video.avi");
                    i++;
                }
                p.Stop();
                frm.Close();
...
## 参考资料
> c#获取摄像头拍照显示图像：[https://mp.weixin.qq.com/s/UC-rUXAaxYkwaei2qMTR8Q](https://mp.weixin.qq.com/s/UC-rUXAaxYkwaei2qMTR8Q)
