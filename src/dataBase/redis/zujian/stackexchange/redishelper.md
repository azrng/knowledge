...
namespace ConsoleApp1
{
    public class RedisHelper
    {
        ...
        /// <param name="dataKey">哈希结构中的键名 </param>
        /// <param name="t">哈希结构中的键名对应的值</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="key">找到这个哈希结构的数据</param>
        /// <param name="dataKey">取里面对应的值</param>
        /// <returns>返回nil时，是里面的这一个值不存在，而不是这个哈希结构数据不存在</returns>
