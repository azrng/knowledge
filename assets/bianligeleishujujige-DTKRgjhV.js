...
<span class="line"><span>{ </span></span>
<span class="line"><span>ary.Add(sp); </span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>2.遍历ArrayList(Queue、Stack)</strong><br> 这里以string为例，当然ArrayList中的元素可以是任何数据类型，遍历时须确认ArrayList中的元素都是同一数据类型。\xA0<br> //遍历元素为string类型的队列</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>foreach (string text in arraylist) </span></span>
<span class="line"><span>{ </span></span>
...
<span class="line"><span>{</span></span>
<span class="line"><span>\xA0 SE se = (SE)list[i];</span></span>
<span class="line"><span>\xA0Console.WriteLine(se.Name);</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span>//foreach遍历</span></span>
<span class="line"><span>foreach (Object obj in list)</span></span>
<span class="line"><span>{</span></span>
<span class="line"><span>\xA0 SE se = (SE)list[i];</span></span>
<span class="line"><span>\xA0 Console.WriteLine(se.Name);</span></span>
...
<span class="line"><span>} </span></span>
<span class="line"><span></span></span>
<span class="line"><span>DataTable遍历行和列的方法和DataSet类似，只是将dataSet.Tables[0]换成具体某张表就可以了。\xA0</span></span>
<span class="line"><span>另外还可以对DataTable表进行SQL查询，然后再对查询结果进行遍历。\xA0</span></span>
...
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>7.遍历ListBOX和ComboBox中的item</strong><br> 一般foreach遍历只能遍历到ListBOX和ComboBox里item的名称,完整遍历需要在绑定item的时候添加的item数据是个二元属性自定义类的对象,将对象中一个属性的名称作为DisplayMember(item名)，另一个作为DisplayValue(item值)。这样在遍历的时候就可以把ListBOX和ComboBox中的item的名称和值全部获取出来了。<br><strong>8.<code>List&lt;T&gt;</code></strong><br><img src="/kbms/common/1613566907278-5449d987-b64b-4095-8bea-56c7a251fcfe.png" alt="image.png" loading="lazy"></p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>//for遍历</span></span>
<span class="line"><span>for (int i = 0; i &lt; list.Count; i++)</span></span>
<span class="line"><span>{</span></span>
<span class="line"><span>\xA0 //遍历时不需要类型转换</span></span>
<span class="line"><span>\xA0Console.WriteLine(list[i]);</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span>//foreach遍历</span></span>
<span class="line"><span>foreach (SE obj in list)</span></span>
<span class="line"><span>{</span></span>
<span class="line"><span>\xA0 //遍历时不需要类型转换</span></span>
<span class="line"><span>\xA0 Console.WriteLine(obj);</span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="/kbms/common/1613566907280-898ead77-c8d3-46fc-8d13-1ce09385b0d5.png" alt="image.png" loading="lazy"><br><strong>9.<code>Dictionary&lt;K,V&gt;</code></strong><br><img src="/kbms/common/1613566907274-e0ac8530-9345-4122-b289-d24249438092.png" alt="image.png" loading="lazy"></p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>//遍历Values</span></span>
<span class="line"><span>foreach (SE se in list.Values)</span></span>
<span class="line"><span>{</span></span>
<span class="line"><span>\xA0 //遍历时不需要类型转换</span></span>
<span class="line"><span>\xA0Console.WriteLine(se);</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>//同时遍历</span></span>
<span class="line"><span>foreach (KeyValuePair&lt;string, SE&gt; en in list)</span></span>
<span class="line"><span>{</span></span>
<span class="line"><span>\xA0 Console.WriteLine(en.Key);</span></span>
<span class="line"><span>\xA0Console.WriteLine(en.Value.Name);</span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>//<code>KeyValuePair&lt;TKey,TValue&gt;</code>是一个泛型结构</p><p>来自 &lt;<a href="https://www.cnblogs.com/H2921306656/p/6675327.html" target="_blank" rel="noopener noreferrer">https://www.cnblogs.com/H2921306656/p/6675327.html</a>&gt;</p>`,20)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};