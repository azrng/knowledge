import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,a as e,o as i}from"./app-og7VwcY5.js";const l="/knowledge/common/1613566907278-5449d987-b64b-4095-8bea-56c7a251fcfe.png",p="/knowledge/common/1613566907280-898ead77-c8d3-46fc-8d13-1ce09385b0d5.png",r="/knowledge/common/1613566907274-e0ac8530-9345-4122-b289-d24249438092.png",t={};function d(c,s){return i(),a("div",null,[...s[0]||(s[0]=[e(`<p><strong>1.枚举类型</strong><br> //遍历枚举类型Sample的各个枚举名称</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>foreach (string sp in Enum.GetNames(typeof(Sample))) </span></span>
